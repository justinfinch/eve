...
- [ADR — Phased control plane](concepts/adr-phased-control-plane.md) — Web Serial v1 → Rust bridge v2; the message contract is the invariant, not the topology. **v1 skipped at Rung 1 (2026-07-10) — bridge built directly, thesis validated on hardware.** `architecture` `adr` `poc`
